...
```
#You can try and download the example file (EXA1.csv) from the link below but if this does not work you can get it from the GitHub site you downloaded this code from.
#If you want to run your own .csv then just change the address to show where on your computer the .csv is stored.
```{r}
